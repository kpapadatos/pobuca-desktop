...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var submenuItem = new gui.MenuItem({ label: 'Display mode', submenu: submenu });
        ...
        let tray = new gui.Tray({ tooltip: 'Pobuca', icon: 'assets/logo.png', menu: menu });
...
class Victor extends eventemitter2_1.EventEmitter2 {
...
class Toast extends eventemitter2_1.EventEmitter2 {
    constructor(options) {
        super();
        this.anchor = {};
        let longevity = 6e3;
...
class ToastManager extends eventemitter2_1.EventEmitter2 {
    constructor(workArea) {
        super();
        this.toasts = [];
        this.TOAST_SPAWNING = false;
        this.spawnToastQueue = [];
